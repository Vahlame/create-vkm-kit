...
| Design UI/visuals that don't look generic                 | the **`/vkm-design`** skill (direction → tokens → visual loop)                                                                               | Claude Code                                      |
| Consolidate web research into a quality summary           | the **`/vkm-research`** skill (wikilinks, `supersedes`; also imports external research reports)                                              | Claude Code                                      |
