...
2. **Clona el kit:** `git clone https://github.com/Vahlame/create-vkm-kit "<KIT>"`.
...
| `python -m obsidian_memory_rag --help` | imprime la ayuda → el backend de Python importa y corre (sin reiniciar) |
