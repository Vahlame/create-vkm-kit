...
Savings per answered query = ``1 - passage_tokens / full_tokens``; the report
gives median, mean, min, max and stdev — not just a mean — so the reader can
see whether the number is solid or noisy.
"""
