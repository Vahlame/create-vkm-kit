/**
 * Shared result shaping for the vkm-downloads MCP tools.
 *
 ...
 * this avoids a cross-workspace runtime dependency (same call obscura-web made,
 * ADR-0051 decision #6). Keep behavior identical.
 *
