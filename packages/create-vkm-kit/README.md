...
| `--skills` / `--no-skills`                         | (Claude Code + Codex) Force on / remove the four skills — `/vkm-discipline`, `/vkm-spec`, `/vkm-design`, `/vkm-research`. Codex receives byte-identical directories under `~/.agents/skills/`. Hash-tracked; uninstall never deletes one you edited.                                                                                                                                                                 |
