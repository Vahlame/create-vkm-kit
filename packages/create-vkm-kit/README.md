...
`/vkm-spec` and `/vkm-design` skills** + the `vkm-implementer` subagent (ADR-0049/0053), and
...
| `--skills` / `--no-skills`                         | (Claude Code) Force on / remove the three skills — `/vkm-discipline`, `/vkm-spec`, `/vkm-design` (ADR-0049/0053). Hash-tracked; uninstall never deletes one you edited.                                                                                                                                                                                            |
