...
| `--skills` / `--no-skills`                         | (Claude Code) Force on / remove the four skills — `/vkm-discipline`, `/vkm-spec`, `/vkm-design`, `/vkm-research` (ADR-0049/0053/0056). Hash-tracked; uninstall never deletes one you edited.                                                                                                                                                                                                                         |
